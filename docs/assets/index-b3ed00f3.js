...
function es(e, n, t) {
  ...
  for (r in n) zc.call(n, r) && !Lc.hasOwnProperty(r) && (l[r] = n[r]);
  if (e && e.defaultProps)
...
function Wc(e, n, t, r, l, o, u, i, s) {
  (_t = !1), (Rr = null), Ac.apply(Bc, arguments);
}
...
var ot = {
  ...
  Ju = we(tl),
  cf = V({}, tl, { dataTransfer: 0 }),
  ff = we(cf),
  df = V({}, Zt, { relatedTarget: 0 }),
  Nl = we(df),
  pf = V({}, ot, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  mf = we(pf),
  vf = V({}, ot, {
...
var Ef = V({}, Zt, {
  ...
  Pf = we(xf),
  Nf = V({}, ot, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  zf = we(Nf),
  Tf = V({}, tl, {
    deltaX: function (e) {
...
var Of = He && "TextEvent" in window && !Ct,
  Fs = He && (!lu || (Ct && 8 < Ct && 11 >= Ct)),
...
function Bs(e) {
  if (e.propertyName === "value" && rl(Ft)) {
    var n = [];
    Vs(n, Ft, e, Zo(e)), ks(If, n);
  }
}
function Uf(e, n, t) {
  e === "focusin"
    ? (li(), (xt = n), (Ft = t), xt.attachEvent("onpropertychange", Bs))
    : e === "focusout" && li();
}
function $f(e) {
...
var Hf = He && "documentMode" in document && 11 >= document.documentMode,
  In = null,
  fo = null,
  Pt = null,
  po = !1;
    ...
    if (!(n & 7)) {
      ...
      P &&
        ...
        0 < C.length &&
          ...
          x ? (P.data = x) : ((x = $s(t)), x !== null && (P.data = x)))),
        (x = Of ? Mf(e, t) : Df(e, t)) &&
...
function vn() {
  if (!Il && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), xs(Jo, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
var Xr = {
  ...
  id = {
    ...
    useTransition: function () {
      var e = _i(!1),
        n = e[0];
      return (e = ld.bind(null, e[1])), (je().memoizedState = e), [n, e];
    },
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && t && uu(n), (n.flags |= 1), oe(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && r && uu(n), (n.flags |= 1), oe(e, n, t, l), n.child)
  );
}
function Li(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Pr(e, n), ia(n, t, r), Co(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function Aa(e) {
  ...
  n !== null && ((e.alternate = null), Aa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[go], delete n[bf], delete n[ed])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ka(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    R |= 2;
    var o = Xa();
    (J !== e || b !== n) && (($e = null), (rt = H() + 500), _n(e, n));
    do
      try {
        Ed();
        break;
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Yt), _n(e, 0), be(e, r), pe(e, H()), t);
    if (n === 6) be(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = xu + 500 - H()), 10 < n))
          ) {
            if (Dr(e, 0) !== 0) break;
  ...
  return pe(e, H()), e.callbackNode === t ? Ka.bind(null, e) : null;
}
function Fo(e, n) {
  var t = Tt;
  return (
...
function $i(e) {
  ...
  if (t === 1) throw ((t = Yt), _n(e, 0), be(e, n), pe(e, H()), t);
...
function wn(e, n, t) {
  var r = O,
    l = _e.transition;
  try {
    (_e.transition = null), (O = 1), _d(e, n, t, r);
  } finally {
    (_e.transition = l), (O = r);
  }
  return null;
...
function Cd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > H() - xu)
        ? _n(e, 0)
        : (Cu |= t)),
    pe(e, n);
}
...
qa = function (e, n, t) {
  ...
  else (ce = !1), F && n.flags & 1048576 && na(n, Br, n.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Co(n, r, e, t),
            (n = No(null, n, r, !0, o, t)))
          : ((n.tag = 0), F && o && uu(n), oe(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), pe(n, H()), !(R & 6) && ((rt = H() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
ws = Pu;
Ss = Tn;
var Md = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, ys, gs, Pu] },
  ht = {
  ...
  Dd = {
    ...
    findFiberByHostInstance: ht.findFiberByHostInstance || Rd,
...
var Bd = lc.exports;
const kt = Hi(Bd),
  ic = ({ lang: e, img: n, fcolor: t, scolor: r }) => (
    console.log(kt),
    Q.jsx("div", {
      className: "parent",
      children: Q.jsx("div", {
...
const Wd = () => {
  ...
  return Q.jsx(Q.Fragment, {
    children: e.map(({ lang: n, url: t, fcolor: r, scolor: l }) =>
      Q.jsx(ic, { lang: n, img: t, fcolor: r, scolor: l }, n)
    ),
  });
};
function Hd() {
...
Ql.createRoot(document.getElementById("root")).render(
  Q.jsx(Cc.StrictMode, { children: Q.jsx(Hd, {}) })
);
